...
angular.module('ngCart', ['ngCart.directives'])
    ...
    .service('ngCart', ['$rootScope', 'ngCartItem', 'store', function ($rootScope, ngCartItem, store) {
        ...
        this.addItem = function (id, name, price, quantity, image, data) {
            ...
            if (typeof inCart === 'object') {
                ...
                if (quantity > 0) {
                    var newItem = new ngCartItem(id, name, price, quantity, image, data);
        ...
        this.getTotalItems = function (prefix) {
            var count = 0;
            var items = this.getItems();
            angular.forEach(items, function (item) {
                if (item._id.indexOf(prefix) === 0)
        ...
        this.getSubTotal = function (prefix) {
            var total = 0;
        ...
        this.totalCost = function (prefix) {
            return +parseFloat(this.getSubTotal(prefix) + this.getShipping() + this.getTax()).toFixed(2);
        };
        ...
        this.$restore = function (storedCart) {
            ...
            angular.forEach(storedCart.items, function (item) {
                self.$cart.items.push(new ngCartItem(item._id, item._name, item._price, item._quantity, item._image, item._data));
            });
            this.$save();
        };
    ...
    .factory('ngCartItem', ['$rootScope', '$log', function ($rootScope, $log) {
        ...
        var item = function (id, name, price, quantity, image, data) {
            this.setId(id);
            this.setName(name);
            this.setPrice(price);
...
angular.module('ngCart.directives', ['ngCart.fulfilment'])
    ...
    .directive('ngcartAddtocart', ['ngCart', function (ngCart) {
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                scope.$watch(scope.quantity, function (value) {
    ...
    .directive('ngcartCartSummary', [function () {
        return {
            restrict: 'E',
            controller: 'CartController',
            scope: {
            ...
            transclude: true,
            templateUrl: '/template/ngCart/cartsummary.html',
            link: function (scope, element, attrs) {
            }
        };
    }])
