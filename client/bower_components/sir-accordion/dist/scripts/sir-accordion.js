    ...
    link: function(scope,element) {
      ...
      */
      var itemRegen = function(collection, parentIndex, currentIndex, level) {
        ...
        header = scope.config.beforeHeader + collection[currentIndex].name + scope.config.afterHeader;
        ...
        if (angular.isArray(collection[currentIndex].sub_categories) && collection[currentIndex].sub_categories.length){
          item = item + itemRegen(collection[currentIndex].sub_categories, uniqueIndex, 0, level + 1);
