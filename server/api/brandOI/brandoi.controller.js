...
exports.index = function(req, res) {
  var q = req.query;
  // setTimeout(function(){
    BrandOI.find(q, function (err, brands) {
...
exports.categoryoi = function(req, res) {
  ...
  BrandOI.find({'category' : parseInt(req.params.id)},function (err, brands) {
    if(err) { return handleError(res, err); }
    return res.status(200).json(brands);
  });
};
...
exports.show = function(req, res) {
  BrandOI.findById(req.params.id, function (err, brand) {
    if(err) { return handleError(res, err); }
...
exports.create = function(req, res) {
  ...
  BrandOI.create(req.body, function(err, brand) {
    if(err) { return handleError(res, err); }
