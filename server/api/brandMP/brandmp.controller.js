...
exports.index = function(req, res) {
  var q = req.query;
  // setTimeout(function(){
   BrandMP.find(q, function (err, brands) {
...
exports.categorymp = function(req, res) {
  ...
  BrandMP.find({'category' : parseInt(req.params.id)},function (err, brands) {
    if(err) { return handleError(res, err); }
    return res.status(200).json(brands);
  });
};
...
exports.show = function(req, res) {
 BrandMP.findById(req.params.id, function (err, brand) {
    if(err) { return handleError(res, err); }
...
exports.create = function(req, res) {
  ...
  BrandMP.create(req.body, function(err, brand) {
    if(err) { return handleError(res, err); }
